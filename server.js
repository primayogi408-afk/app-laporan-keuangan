...
// INIT: copy bundled data/master.xlsx from repo to /tmp so data persists
  ...
  try {
    ...
    for (const f of files) {
      ...
      if (fs.statSync(src).isFile() && !fs.existsSync(dest)) {
        ...
        console.log('Copied bundled', f, 'to', dest);
      }
    }
  } catch(e){ console.log('init bundler error', e.message); }
})();
